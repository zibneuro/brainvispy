...
* **Install VTK.** Follow [these](./install_vtk_win.md) instructions.
...
* **Run BrainVisPy.**
  ...
  * Alternatively, read [here](./single_executable_file.md) how to create a single executable file.
...
* **Install VTK.** Follow [these](./install_vtk_linux.md) instructions.
...
* **Install VTK.** Follow [these](./install_vtk_osx.md) instructions.
