...
The main classes in this module are [DataContainer](../core/datacontainer.py) and [Controller](../core/controller.py) which are introduced above.

### generators

The [NeuronGenerator](../generator/neurongenerator.py) and [NeuralConnectionGenerator](../generator/neuralconnectiongenerator.py) generate neurons and neural connections, respectively, with the corresponding visual representation.
